...
const Ppf = () => {
  ...
  return (
    <>
              ...
              <div className="p-4 w-[100%] lg:w-[600px] xl:w-[500px] font-semibold text-[17px]">
                ...
                <div className="mt-12">
                  <p className="flex items-center justify-between">
                    ...
                    <div>
                      <input
                        className="border border-[#B9BABD] p-2 rounded-md bg-white w-16 text-center"
                        type="number"
                      ...
                      />
                      <button className="bg-[#3551E7] text-white mx-3 px-3 p-2 border border-[#B9BABD] rounded-md">
                        Years
                      </button>
                    </div>
                  </p>
                ...
                <div className="mt-12">
                  <p className="flex items-center justify-between">
                    ...
                    <div>
                      ...
                      <button className="border border-[#B9BABD] p-2 rounded-r-md">
                        %
                      </button>
                    </div>
                  </p>
      ...
      {/* Theory */}
      <div className="mx-4 md:mx-16 md:my-10 lg:mt-14 xl:mx-20 xl:my-20 lg:mr-[150px] xl:mr-[520px]">
