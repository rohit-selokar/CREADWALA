...
const Work = () => {
  return (
    <div className="my-10 px-8 md:flex md:justify-around md:items-center">
      <div className="">
        <div className="text-center  md:text-start">
          <p className="text-[30px] font-bold lg:text-[34px] xl:text-[45px]">
            How <span className="text-[#474FFF] ">credwala</span> works ?
          </p>
          <p className="text-[#111111] text-[16px] md:my-2 lg:text-[18px] xl:text-[22px]">
        ...
        <div className="md:p-3">
          <div className="flex items-center my-2 lg:my-4 xl:my-8">
            ...
            <p className="font-semibold text-[15px] p-2 md:p-5 lg:text-[17px] xl:text-[22px]">
