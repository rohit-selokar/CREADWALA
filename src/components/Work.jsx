    ...
    <div className="mx-4 xl:container xl:mx-auto max-w-7xl px-2 my-14 md:flex md:justify-around md:items-center">
      <div>
        <div className="text-center  md:text-start">
          ...
          <p className="text-[#111111] text-[16px] md:my-2 lg:text-[18px] xl:text-[19px]">
            Credwala connects personal loan borrowers with investors
          </p>
        </div>
        <div className="md:p-3">
          <div className="flex items-center my-2 lg:my-4 xl:my-8">
            <img src={img1} className="w-14 lg:w-20" />
            <p className="font-semibold text-[15px] p-2 md:p-5 lg:text-[17px]">
              Digitally Connect borrowers and investors
            </p>
          </div>

          <div className="flex items-center my-2 lg:my-4 xl:my-8">
            <img src={img2} className="w-14 lg:w-20" />
            <p className="font-semibold text-[15px] p-2 md:p-5 lg:text-[17px]">
          ...
          <div className="flex items-center my-2 lg:my-4 xl:my-8">
            <img src={img3} className="w-14 lg:w-20" />
            <p className="font-semibold text-[15px] p-2 md:p-5 lg:text-[17px]">
