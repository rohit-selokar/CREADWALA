...
const First = () => {
  return (
    ...
    >
      <div className="mx-4 container xl:mx-auto max-w-7xl font-manrope text-center">
        <div className="xl:py-8">
          <div className="md:flex items-center md:text-start">
            <div className="md:order-2 flex justify-center">
              <img src={first} className="lg:mt-2 w-[420px] xl:w-[750px]" alt="First Image" />
            </div>
