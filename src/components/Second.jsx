...
const Second = () => {
  return (
    <div className="bg-[#474FFF] text-white">
      <div className="container mx-auto text-[13px] font-semibold font-manrope grid grid-cols-2 gap-2 p-2 md:grid-cols-4 lg:grid-cols-4 xl:px-[25px] xl:text-[17px] xl:gap-0">
